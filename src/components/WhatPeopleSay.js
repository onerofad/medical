import { Grid, GridColumn, GridRow, Header, HeaderContent, HeaderSubheader, Image, Segment } from "semantic-ui-react"
...
const WhatPeopleSay = () => {
    return(
            <div style={{margin: 0, padding: '100px', background: '#F8F9FA'}}>
                 <Header
                style={{
                    color: '#333',
                    textAlign: 'center',
